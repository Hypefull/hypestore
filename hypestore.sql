...
(3, 'Harry Potter', 'J. K. Rowling', '127000', 21, 'harrypotter.jpg', 'Harry Potter is a series of seven children\'s fantasy novels written by British author J. K. Rowling. The novels chronicle the lives of a young wizard, Harry Potter, and his friends, Ron Weasley and Hermione Granger, among others, all of whom are students at Hogwarts School of Witchcraft and Wizardry.', 3, 4),
...
(7, 'Diary of a Wimpy Kid', 'Jeff Kinney', '300000', 40, 'diaryofawimpykid.jpg', 'Diary of a Wimpy Kid is an American illustrated children\'s novel series and media franchise created by author and cartoonist Jeff Kinney. The series follows Greg Heffley, a middle-schooler who illustrates his daily life in a diary. The characters of the book were first designed in 1998.', 8, NULL),
(8, 'The Anarchist Handbook', 'Michael Malice', '500000', 20, 'anarchist.jpg', 'Anarchism has been both a vision of a peaceful, cooperative society—and an ideology of revolutionary terror. Since the term itself—anarchism—is a negation, there is a great deal of disagreement on what the positive alternative would look like. The black flag comes in many colors.The Anarchist Handbook is an opportunity for all these many varied voices to speak for themselves, from across the decad', 5, NULL),
(9, 'Animal Farm', 'George Orwell', '300000', 12, 'animalfarm.jpg', 'Animal Farm is a satirical allegorical dystopian novella, in the form of a beast fable, by George Orwell, first published in England on 17 August 1945.', 3, NULL),
...
(12, 'Thus Spoke Zarathustra', 'Friedrich Nietzsche', '350000', 9, 'thusspoke.jpg', 'Thus Spoke Zarathustra: A Book for All and None, also translated as Thus Spake Zarathustra, is a work of philosophical fiction written by German philosopher Friedrich Nietzsche and published in four volumes between 1883 and 1885', 5, NULL),
...
(14, 'Laskar Pelangi', 'Andrea Hirata', '200000', 21, 'laskarpelangi.jpg', 'Laskar Pelangi adalah novel fenomenal karya Andrea Hirata (2005) dan film adaptasi populer garapan Riri Riza (2008). Kisahnya menceritakan perjuangan 10 anak dari keluarga miskin di Belitung yang bersekolah di SD Muhammadiyah Gantong yang nyaris ditutup, namun tetap gigih mengejar mimpi dengan bimbingan Ibu Muslimo dan Pak Harfan.', 3, NULL),
